...
public class MailTemplateTests
{
    ...
    [InlineData("es", "Géminis", "José", 2029, "es")]
    [InlineData("es-mx", "Géminis", "José", 2027, "es")]
    ...
    )
    {
        ...
        IMailMessage message = template.Load(_templateFolder, _templateId, language, ".html", data);
